  ...
  head: () => ({
    meta: [
      ...
      { title: "CHAVA — Kosher Interiors for Jewish Homes" },
      {
        name: "description",
        content:
          "CHAVA is a premium interior and custom furniture studio designing homes where beauty, function and Jewish tradition live together.",
      },
      { name: "author", content: "CHAVA" },
